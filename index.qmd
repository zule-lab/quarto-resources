...
author: "Isabella C. Richmond + Nicole Yu + Alec L. Robitaille"
date: "`r Sys.Date()`"
listing:
  - contents: "*/**qmd"
    type: table
...
This website is for hosting all the important/most commonly used resources from the ZULE Lab. Check the left sidebar for different categories, and then click on whatever topic is most relevant to you to get the info you need!
